...
export default function ChatPanel({ response, isTyping, thinkingMessage, apiError, model, provider, tokens }) {
            ...
            >
              ...
              <div className="flex-1 glass-card-sm p-4 border border-av-error/20">
                ...
                <div className="text-[10px] text-av-muted mt-3">
                  Check your Gemini API key at ai.google.dev
                </div>
              </div>
            </motion.div>
          )}
          ...
          {!response && !isTyping && !apiError && (
            ...
            >
              <div className="text-center">
                ...
                <div className="text-[10px] mt-1 text-av-muted/60">Powered by Google Gemini AI</div>
              </div>
            </motion.div>
          )}
        </AnimatePresence>
