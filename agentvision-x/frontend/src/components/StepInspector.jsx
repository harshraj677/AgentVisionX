  ...
  return (
    ...
    >
      ...
      <div className="flex-1 overflow-y-auto p-3 space-y-2.5">
        {/* Step Name + Status + Pipeline Type */}
        ...
        {/* ═══ AI Decision Reason (Explainable AI) ═══ */}
        {step.decision_reason && (
          <motion.div
            initial={{ opacity: 0, y: 5 }}
            animate={{ opacity: 1, y: 0 }}
            className="glass-card-sm p-3 border border-amber-500/20 bg-amber-500/5"
          >
            <div className="text-xs text-amber-400 mb-1.5 uppercase tracking-wider font-semibold flex items-center gap-1.5">
              <span>💡</span> AI Decision Reason
            </div>
            <div className="text-xs text-av-text leading-relaxed">
              {step.decision_reason}
            </div>
          </motion.div>
        )}
        ...
        {/* Reasoning */}
        {step.reasoning && !step.reasoning.startsWith('cost=') && (
          <div className="glass-card-sm p-3">
